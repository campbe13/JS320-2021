...
## [korra](https://korra.dawsoncollege.qc.ca/~tricia/) all code examples used in the lectures & some extras, live on a web server
## Lab 02-02 week 2
...
* Full demo of building a React app [korra](https://korra.dawsoncollege.qc.ca/~tricia/js/15-demo-json-to-cards/) start to finish
